...
export class Util {
  ...
  // to "sanitize" some incredible JavaScript float point results, like
  // 99.9 - 100 = -0.09999999999999432
  static floatSanitize = (number: any) => Number(number.toPrecision(5));
   ...
   */
  static roundToSignificantDigits = (number: any, significantDigits: any) =>
   ...
   */
  static truncateToSignificantDigits = (number: any, significantDigits: any) => {
   ...
   */
  static changeObjectPropertiesToNumber(Obj: any) {
    for (let prop in Obj) {
   ...
   */
  static limitValueToMinMax(value: any, min: any, max: any) {
  ...
  static linearCoerceValueToMinMax(value: any, min: any, max: any) {
  ...
  static nonLinearCoerceValueToMinMax(value: any, min: any, max: any) {
    if (value >= min && value <= max) return value;
   ...
   */
  static convert = ({ value, fromBase, toBase }: any) => {
   ...
   */
  static linearConversionWithMaxAndMin = ({
    fromBaseMin, fromBaseMax, toBaseMin, toBaseMax, valueToConvert, }: any) => {
   ...
   */
  static removeTagsFromString = (html: any) => {
