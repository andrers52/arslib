...
export class Time {
// defs
  static TIME_1_SEC = 1000;
  static TIME_1_MIN = 60 * Time.TIME_1_SEC;
  static TIME_1_H = 60 * Time.TIME_1_MIN;
  static TIME_1_DAY = 24 * Time.TIME_1_H;
...
// convert number of occurrences in time to delay between occurrences
  static frequencyToDelay = (numberOfOccurrences: any, time: any) => {
 ...
 */
  static dateAs_yyyy_mm_dd_hh_mm_ss = (date: any = new Date()) => {
