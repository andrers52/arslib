  ...
  async () => {
    if (!Platform.isNode()) {
      ...
      expect.toBeType(
        mockObj.log,
        "function",
        "The mixin adds empty stub log in non-Node environment",
      );
      expect.toBeType(
        mockObj.enableLog,
        "function",
        "The mixin adds stub enableLog in non-Node environment",
      );
      expect.toBeType(
        mockObj.disableLog,
        "function",
        "The mixin adds stub disableLog in non-Node environment",
      );
      return;
    }
