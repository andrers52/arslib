 ...
 */
  static sum = (array: any) => array.reduce((total, num) => total + num, 0);
...
// mean difference, taken two by two (-1 if not applicable)
  static meanDifferenceTwoByTwo = (array: any) => {
 ...
 */
  static first = (array: any) => (array.length >= 1 ? array[0] : "undefined");
 ...
 */
  static isLast = (array: any, item: any) => item === this.last();
 ...
 */
  static isFirst = (array: any, item: any) => item === this.first();
...
// Note: preserveOriginalArray === true is slower
  static flatten = (array: any, preserveOriginalArray: any = true) => {
...
// Note: preserveOriginalArray === true is slower
  static unflatten = (flattenedArray: any, size: any, preserveOriginalArray: any = true) => {
 ...
 */
  static clone = (array: any, cloneFunction: any) => {
  if (!cloneFunction)
    return array.map((e) =>
...
//get random element from array (with different chances for each one)
  static choiceWithProbabilities = (array: any, probabilities: any) => {
...
//get random element from array
  static choice = (array: any) => array[Random.randomInt(array.length)];
...
//get random index from array
  static indexChoice = (array: any) => Random.randomInt(array.length);
 ...
 */
  static indexOfGreaterValue = (array: any) => {
  let greater = array[0];
  let resultIndex = 0;
  for (let i = 1; i < array.length; i++)
    if (array[i] > greater) {
...
// }
  ...
  static range = function* (begin: any, end: any) {
