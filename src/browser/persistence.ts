...
export class Persistence {
  ...
  static instances: any = {}; // To store instances per namespace
   ...
   */
  static getInstance(namespace: any, ...entities: any[]) {
    if (!Persistence.instances[namespace]) {
      Persistence.instances[namespace] = Persistence.createPersistenceInstance(namespace, ...entities);
    }
    ...
    return Persistence.instances[namespace];
  };

  static createPersistenceInstance(namespace: any, ...entities: any[]) {
