...
export class ImageUtil {
  ...
  static createCanvas(width: any, height: any) {
  ...
  static createPieGraph(width: any, height: any, colorsAndPercentages: any) {
   ...
   */
  static createPieGraphWithEvenlyDistributedColors(width: any, height: any, colors: any, ) {
