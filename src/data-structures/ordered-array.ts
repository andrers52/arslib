 ...
 */
  static binarySearch = (array: any, target: any, searchOnlyExactValue: any = true) => {
 ...
 */
  static findFirstIndexGreaterOrEqual = (array: any, value: any) => {
 ...
 */
  static findLastIndexSmallerOrEqual = (array: any, value: any) => {
  let resultIndex = OrderedArray.binarySearch(array, value, false);
  if (array[resultIndex] <= value) return resultIndex;
  let adjustedResultIndex = resultIndex - 1;
  if (
